...
ifndef LAPACK_LIB
  S4_LIBOBJS += $(OBJDIR)/Eigensystems.o
endif
...
$(OBJDIR)/S4k/main_lua.o: S4/main_lua.c
...
S4rlua: $(OBJDIR)/S4r/main_lua.o $(OBJDIR)/S4r/lua_named_arg.o $(OBJDIR)/S4r/S4r.o $(S4r_LIBNAME)
